...
export default function SuperAdminContentPlannerPage() {
  ...
  const [contentPosts, setContentPosts] = useState([
    {
      ...
      content: 'Get ready for our biggest sale of the year! 50% off everything. #HolidaySale #BigSavings',
      type: 'image',
      platform: ['facebook', 'instagram'],
      scheduledDate: '2024-12-15',
      scheduledTime: '10:00',
      status: 'scheduled',
      hashtags: ['#HolidaySale', '#BigSavings', '#Fashion']
    },
    {
      id: 2,
      title: 'Behind the Scenes Video',
      content: 'Take a peek behind the scenes at our design process...',
      type: 'video',
      platform: ['facebook', 'instagram', 'linkedin'],
      scheduledDate: '2024-12-16',
      scheduledTime: '14:30',
      status: 'draft',
      hashtags: ['#BehindTheScenes', '#Design', '#Process']
    }
  ]);
