...
export default function FeesPendingPage() {
  ...
  useEffect(() => {
    if (!tenantId) {
      console.log("⏳ Waiting for tenantId to load...");
      return;
    }
    fetchFiltersData();
  }, [tenantId]);
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Link href={`/dashboard/accounts/add-payment`}>
            ...
            <Link href={`/dashboard/accounts/overview`}>
                    ...
                    <tr key={student._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <Link href={`/dashboard/accounts/receipts?search=${student.rollNumber}`}>
                            <button
