...
export default function EditExamPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/(tenantadmin)/scholarship-exams`);
    } catch (error: any) {
          ...
          {currentTab === "basic" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Tenant Website URL (Optional)</label>
                  <input
                    type="url"
                    value={tenantWebsite}
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {tenantWebsite 
                      ? `Students will be redirected to ${tenantWebsite} after registration`
