  ...
  const lmsModules = [
    {
      ...
      icon: BookOpen,
      href: `/dashboard/(tenantadmin)/lms/subjects`,
      color: 'bg-blue-500',
      stats: '5 Active',
    },
    {
      ...
      icon: FileText,
      href: `/dashboard/(tenantadmin)/lms/chapters`,
      color: 'bg-purple-500',
      stats: '25 Chapters',
    },
    {
      ...
      icon: BarChart3,
      href: `/dashboard/(tenantadmin)/lms/questions`,
      color: 'bg-green-500',
      stats: 'AI Powered',
    },
    {
      ...
      icon: FileText,
      href: `/dashboard/(tenantadmin)/lms/tests`,
      color: 'bg-orange-500',
      stats: '0 Tests',
    },
    {
      ...
      icon: Video,
      href: `/dashboard/(tenantadmin)/lms/lessons`,
      color: 'bg-pink-500',
      stats: '0 Lessons',
    },
    {
      ...
      icon: BarChart3,
      href: `/dashboard/(tenantadmin)/lms/student-progress`,
      color: 'bg-indigo-500',
      stats: 'Real-time',
    },
  ];
