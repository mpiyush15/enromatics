          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 text-center max-w-md mx-auto">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6 text-xs">
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3">
                ...
                <div className="text-gray-600 dark:text-gray-400">Campaign insights</div>
              </div>
              <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3">
                <div className="text-lg mb-1">🎯</div>
                <div className="font-medium text-gray-900 dark:text-white">Ad Management</div>
                <div className="text-gray-600 dark:text-gray-400">Create & optimize</div>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Social Media</h1>
            <p className="text-sm text-gray-600 dark:text-gray-400">Manage your Facebook advertising campaigns</p>
          </div>
          <button
            onClick={() => refresh()}
            disabled={dataLoading}
            className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50"
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400">Ad Accounts</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400">Active Campaigns</div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center text-lg group-hover:scale-110 transition-transform">🎯</div>
              <div>
                <div className="font-medium text-gray-900 dark:text-white text-sm">Campaigns</div>
                <div className="text-xs text-gray-600 dark:text-gray-400">Manage ads</div>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center text-lg group-hover:scale-110 transition-transform">📊</div>
              <div>
                <div className="font-medium text-gray-900 dark:text-white text-sm">Analytics</div>
                <div className="text-xs text-gray-600 dark:text-gray-400">Performance data</div>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center text-lg group-hover:scale-110 transition-transform">✨</div>
              <div>
                <div className="font-medium text-gray-900 dark:text-white text-sm">Create Ad</div>
                <div className="text-xs text-gray-600 dark:text-gray-400">New campaign</div>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center text-lg group-hover:scale-110 transition-transform">⚙️</div>
              <div>
                <div className="font-medium text-gray-900 dark:text-white text-sm">Settings</div>
                <div className="text-xs text-gray-600 dark:text-gray-400">Account setup</div>
              </div>
            </div>
          </Link>
        </div>
        ...
        {dashboardData?.adAccounts && dashboardData.adAccounts.length > 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
            <div className="p-4 border-b border-gray-200 dark:border-gray-700">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white">Ad Accounts</h2>
              <p className="text-sm text-gray-600 dark:text-gray-400">Your connected Facebook ad accounts</p>
            </div>
            <div className="p-4">
                ...
                {dashboardData.adAccounts.map((account) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-gray-600 dark:text-gray-400">{account.currency}</div>
                    </div>
                  </div>
                ))}
              </div>
