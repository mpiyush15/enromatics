  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Header */}
        <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-red-700 rounded-3xl shadow-2xl p-8 text-white">
          <h1 className="text-4xl font-bold mb-2">📈 WhatsApp Reports</h1>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
              ...
              <div className="flex gap-2">
                <select
                  ...
                  className="px-4 py-2 border-2 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700"
                >
                ...
                <tbody className="divide-y">
                  {messages.map((msg) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-bold inline-flex items-center gap-1 ${getStatusBadge(
                            msg.status
                          )}`}
                        >
